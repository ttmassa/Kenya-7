Player = function (game, canvas) {
    ...
    window.addEventListener("keyrun", function (evt) {
        if (evt.keyCode === 69) {
            this.speed = 4;
        } else {
            this.speed = 1.5;
...
Player.prototype = {
    _initCamera: function (scene, canvas) {
        ...
        // On crée la caméra
        this.camera = new BABYLON.FreeCamera("camera", new BABYLON.Vector3(0, 10, 0), scene);
    ...
    _checkMove: function (ratioFps) {
        ...
        for (var i = 0; i < this.ghostPlayers; i++) {
